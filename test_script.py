...
from envoy_reader import feature_production
...
IQEnvoyReader.set_required_sensors(feature_production)
print("\n\tIQ Envoy Case requrirs product sensor only with update interval {}".format(IQEnvoyReader.update_interval))
